...
Run_SingleR<-function(DataPath,LabelsPath,CV_RDataPath, output_dir){
  ...
  write.csv(True_Labels_SingleR,paste0(output_dir,'/SingleR_true.csv'),row.names = FALSE)
  write.csv(Pred_Labels_SingleR,paste0(output_dir,'/SingleR_pred.csv'),row.names = FALSE)
